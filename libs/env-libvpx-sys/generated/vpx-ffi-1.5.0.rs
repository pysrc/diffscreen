...
use std::os::raw::*;
pub const VPX_IMAGE_ABI_VERSION: u32 = 3;
...
pub const VPX_CODEC_ABI_VERSION: u32 = 6;
...
pub const VPX_ENCODER_ABI_VERSION: u32 = 11;
...
pub type vpx_release_frame_buffer_cb_fn_t = ::std::option::Option<
  unsafe extern "C" fn(priv_: *mut c_void, fb: *mut vpx_codec_frame_buffer_t)
    -> c_int,
>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type vpx_codec_put_frame_cb_fn_t = ::std::option::Option<
  unsafe extern "C" fn(user_priv: *mut c_void, img: *const vpx_image_t),
>;
extern "C" {
