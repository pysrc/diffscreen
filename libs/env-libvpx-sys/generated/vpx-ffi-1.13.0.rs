...
pub const VPX_EXT_RATECTRL_ABI_VERSION: u32 = 6;
...
pub const VPX_ENCODER_ABI_VERSION: u32 = 30;
...
pub struct vpx_rc_encodeframe_decision {
    ...
    pub max_frame_size: ::std::os::raw::c_int,
}
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct vpx_rc_gop_info {
    pub min_gf_interval: ::std::os::raw::c_int,
    pub max_gf_interval: ::std::os::raw::c_int,
    pub active_min_gf_interval: ::std::os::raw::c_int,
    pub active_max_gf_interval: ::std::os::raw::c_int,
    pub allow_alt_ref: ::std::os::raw::c_int,
    pub is_key_frame: ::std::os::raw::c_int,
    pub last_gop_use_alt_ref: ::std::os::raw::c_int,
    pub frames_since_key: ::std::os::raw::c_int,
    pub frames_to_key: ::std::os::raw::c_int,
    pub lag_in_frames: ::std::os::raw::c_int,
    pub show_index: ::std::os::raw::c_int,
    pub coding_index: ::std::os::raw::c_int,
    pub gop_global_index: ::std::os::raw::c_int,
}
pub type vpx_rc_gop_info_t = vpx_rc_gop_info;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type vpx_rc_create_model_cb_fn_t = ::std::option::Option<
    unsafe extern "C" fn(
        ...
        rate_ctrl_model_pt: *mut vpx_rc_model_t,
    ) -> vpx_rc_status_t,
>;
...
pub type vpx_rc_get_encodeframe_decision_cb_fn_t = ::std::option::Option<
    unsafe extern "C" fn(
        rate_ctrl_model: vpx_rc_model_t,
        encode_frame_info: *const vpx_rc_encodeframe_info_t,
...
pub type vpx_rc_get_gop_decision_cb_fn_t = ::std::option::Option<
    unsafe extern "C" fn(
        rate_ctrl_model: vpx_rc_model_t,
        gop_info: *const vpx_rc_gop_info_t,
